...
<p align="center">
  <img src="./assets/demo.png" alt="TectonicEditor 演示" width="800" />
</p>

<p align="center">
  <a href="https://claudeprism.anomalyco.dev?utm_source=github&utm_medium=readme&utm_campaign=launch_v054">官网</a> ·
  <a href="https://github.com/anomalyco/tectonic-editor/releases/latest/download/TectonicEditor-macOS.dmg">macOS (Apple Silicon)</a> ·
  <a href="https://github.com/anomalyco/tectonic-editor/releases/latest/download/TectonicEditor-macOS-Intel.dmg">macOS (Intel)</a> ·
  <a href="https://github.com/anomalyco/tectonic-editor/releases/latest/download/TectonicEditor-Windows-setup.exe">Windows</a> ·
  <a href="https://github.com/anomalyco/tectonic-editor/releases/latest/download/TectonicEditor-Linux.AppImage">Linux</a> ·
  <a href="https://github.com/anomalyco/tectonic-editor/releases">所有版本</a>
</p>

---

## 为什么选择 TectonicEditor？

[OpenAI Prism](https://openai.com/prism/) 是一个云端 LaTeX 工作区 — 使用它需要将所有文件和数据上传到 OpenAI 的服务器。

TectonicEditor 是**本地优先**的替代方案 — 文件存储在本地磁盘，离线编译。AI 功能通过 Anthropic API 发送内容进行推理（参见[数据使用政策](https://code.claude.com/docs/en/data-usage)）。
...
### Python 环境（uv）
TectonicEditor 集成了 [uv](https://docs.astral.sh/uv/) — 快速的 Python 包管理器。一键安装 uv，一键创建项目级虚拟环境。Claude Code 在运行 Python 代码时自动使用 `.venv`，因此您可以在编辑器中直接生成图表、运行分析脚本和处理数据。
...
### 模板与项目向导快速开始
选择模板（论文、学位论文、演示文稿、海报、信函等），命名，可选描述写作内容 — TectonicEditor 设置项目并通过 AI 生成初始内容。拖放参考文件（PDF、BIB、图片）即可立即开始写作。
...
从 [GitHub Releases](https://github.com/anomalyco/tectonic-editor/releases) 下载最新版本。
